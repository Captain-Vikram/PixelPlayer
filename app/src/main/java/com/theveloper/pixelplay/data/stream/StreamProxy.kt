 ...
 * @see com.theveloper.pixelplay.data.telegram.TelegramStreamProxy standalone Telegram proxy.
 * @see com.theveloper.pixelplay.data.gdrive.GDriveStreamProxy standalone GDrive proxy.
 */
