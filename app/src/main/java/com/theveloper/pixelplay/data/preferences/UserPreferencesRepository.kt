...
class UserPreferencesRepository @Inject constructor(
    ...
    val pauseOnVolumeZeroFlow: Flow<Boolean> = pref { it[PreferencesKeys.PAUSE_ON_VOLUME_ZERO] ?: false }
    suspend fun setPauseOnVolumeZero(enabled: Boolean) {
        dataStore.edit { it[PreferencesKeys.PAUSE_ON_VOLUME_ZERO] = enabled
    }
    ...
    val artistDelimitersFlow: Flow<List<String>> = pref {
        val raw = it[PreferencesKeys.ARTIST_DELIMITERS]?.split("|") ?: DEFAULT_ARTIST_DELIMITERS
        normalizeLegacyDefaultArtistDelimiters(raw)
    }
    ...
    companion object {
        ...
        val LEGACY_DEFAULT_ARTIST_DELIMITERS = listOf("/", ";", ",", "+", "&")
