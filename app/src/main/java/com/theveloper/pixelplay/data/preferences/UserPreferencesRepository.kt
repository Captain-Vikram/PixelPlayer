...
suspend fun markDirectoryRulesVersionApplied(version: Int) {
    ...
    val extensionMediaCacheLimitMbFlow: Flow<Int> = pref {
        it[PreferencesKeys.EXTENSION_MEDIA_CACHE_LIMIT_MB] ?: DEFAULT_EXTENSION_MEDIA_CACHE_LIMIT_MB
    }
    suspend fun setExtensionMediaCacheLimitMb(limitMb: Int) {
        dataStore.edit { it[PreferencesKeys.EXTENSION_MEDIA_CACHE_LIMIT_MB] = limitMb }
    }
