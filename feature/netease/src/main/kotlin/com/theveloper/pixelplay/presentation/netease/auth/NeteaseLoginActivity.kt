...
import com.theveloper.pixelplay.feature.netease.R
...
fun NeteaseWebLoginScreen(
    ...
    if (showExitDialog) {
        AlertDialog(
            ...
            title = {
                Text(text = stringResource(R.string.auth_netease_exit_title), fontFamily = FontFamily.SansSerif)
            },
            text = {
                Text(
            ...
            confirmButton = {
                TextButton(
                    ...
                    Text(text = stringResource(R.string.auth_exit_action), fontFamily = FontFamily.SansSerif, maxLines = 1, overflow = TextOverflow.Ellipsis)
                }
            },
            dismissButton = {
                TextButton(onClick = { showExitDialog = false }) {
                    Text(text = stringResource(R.string.auth_stay_action), fontFamily = FontFamily.SansSerif, maxLines = 1, overflow = TextOverflow.Ellipsis)
                }
            }
        )
    }
                ...
                ElevatedCard(
                    ...
                    Row(
                        ...
                        TextButton(
                            ...
                            Text(text = stringResource(R.string.auth_web_retry_action), fontFamily = FontFamily.SansSerif, maxLines = 1, overflow = TextOverflow.Ellipsis)
                        }
                    }
                }
