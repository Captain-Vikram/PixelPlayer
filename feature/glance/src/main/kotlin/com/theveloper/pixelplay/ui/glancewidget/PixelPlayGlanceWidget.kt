...
class PixelPlayGlanceWidget : GlanceAppWidget() {
    ...
    private fun WidgetUi(
        ...
        val title = playerInfo.songTitle.ifEmpty { context.getStringByName("app_name") }
        val artist = playerInfo.artistName.ifEmpty { context.getStringByName("widget_tap_to_open") }
        ...
        val baseModifier = GlanceModifier
            .fillMaxSize()
            .clickable(actionStartActivity(ComponentName("com.theveloper.pixelplay", "com.theveloper.pixelplay.MainActivity")))
        ...
        Box(
            ...
            Row(
                ...
                Column(modifier = GlanceModifier.defaultWeight()) {
                    ...
                    if (artist.isNotEmpty() && artist != context.getStringByName("widget_tap_to_open")) {
        ...
        Box(
            ...
            Column(modifier = GlanceModifier.fillMaxSize(), horizontalAlignment = Alignment.CenterHorizontally) {
                Row(verticalAlignment = Alignment.CenterVertically, modifier = GlanceModifier.fillMaxWidth().padding(bottom = 8.dp)) {
                    ...
                    Image(
                        provider = ImageProvider(if (isFavorite) context.getDrawableIdByName("round_favorite_24") else context.getDrawableIdByName("rounded_favorite_24")),
                        contentDescription = context.getStringByName("common_favorite"),
                        modifier = GlanceModifier
                            .size(28.dp)
...
//                )
        ...
        Box(
            ...
            if (imageProvider != null) {
                Image(
                    ...
                    contentDescription = context.getStringByName("widget_album_art"),
                ...
                Box(
                    ...
                    Image(
                        provider = ImageProvider(context.getDrawableIdByName("ic_music_placeholder")),
                        contentDescription = context.getStringByName("widget_album_art_placeholder"),
    ...
    fun PlayPauseButtonGlance(
        ...
        iconColor: ColorProvider = GlanceTheme.colors.onPrimaryContainer,
        iconSize: Dp = 24.dp,
        ...
        Box(
            ...
            Image(
                provider = ImageProvider(if (isPlaying) context.getDrawableIdByName("rounded_pause_24") else context.getDrawableIdByName("rounded_play_arrow_24")),
                contentDescription = context.getStringByName(if (isPlaying) "common_pause" else "common_play"),
    ...
    fun NextButtonDGlance(
        ...
        iconProvider: ImageProvider? = null,
        iconSize: Dp = 24.dp,
        ...
        val resolvedIconProvider = iconProvider ?: ImageProvider(context.getDrawableIdByName("rounded_skip_next_24"))
        ...
        Box(
            ...
            Image(
                provider = resolvedIconProvider,
                contentDescription = context.getStringByName("common_next_track"),
                modifier = GlanceModifier.size(iconSize),
                colorFilter = ColorFilter.tint(iconColor)
            )
        }
    ...
    fun NextButtonGlance(
        ...
        Box(
            ...
            Image(
                provider = ImageProvider(context.getDrawableIdByName("rounded_skip_next_24")),
                contentDescription = context.getStringByName("common_next_track"),
                modifier = GlanceModifier.size(iconSize),
                colorFilter = ColorFilter.tint(iconColor)
            )
    ...
    fun PreviousButtonGlance(
        ...
        Box(
            ...
            Image(
                provider = ImageProvider(context.getDrawableIdByName("rounded_skip_previous_24")),
                contentDescription = context.getStringByName("common_previous_track"),
                modifier = GlanceModifier.size(iconSize),
                colorFilter = ColorFilter.tint(iconColor)
            )
        }
