...
class PlayerControlActionCallback : ActionCallback {
    ...
    override suspend fun onAction(
        ...
        val serviceIntent = Intent().apply {
            component = android.content.ComponentName(context.packageName, "com.theveloper.pixelplay.data.service.MusicService")
            this.action = action
        ...
        try {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                try {
                    ...
                    serviceIntent.putExtra("extra_force_foreground_on_start", true)
