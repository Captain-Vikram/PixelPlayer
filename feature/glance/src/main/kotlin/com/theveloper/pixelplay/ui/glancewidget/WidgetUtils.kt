...
fun android.content.Context.getStringByName(name: String): String {
    val id = resources.getIdentifier(name, "string", packageName)
    return if (id != 0) getString(id) else ""
}

fun android.content.Context.getStringIdByName(name: String): Int {
    return resources.getIdentifier(name, "string", packageName)
}

fun android.content.Context.getDrawableIdByName(name: String): Int {
