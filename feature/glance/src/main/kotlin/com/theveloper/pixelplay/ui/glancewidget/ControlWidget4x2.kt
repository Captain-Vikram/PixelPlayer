        ...
        Box(
            ...
            Column(
                ...
                Row(
                    ...
                    val buttonColor = if (repeatMode == 0) colors.prevNextBackground else colors.onSurface
                    val iconRes = context.getDrawableIdByName(if (repeatMode == 1) "rounded_repeat_one_24" else "rounded_repeat_24")
                    val iconColor = if (repeatMode == 0) colors.prevNextIcon else colors.surface
                    RepeatButton(
                        modifier = buttonModifier,
