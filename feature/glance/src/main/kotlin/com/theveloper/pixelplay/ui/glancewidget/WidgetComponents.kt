...
fun AlbumArtImage(
    ...
    val cdAlbumArt = context.getStringByName("widget_album_art")
    val cdPlaceholder = context.getStringByName("widget_album_art_placeholder")
    Box(
        modifier = modifier
    ) {
...
fun PreviousButton(
    ...
    WidgetIconButton(
        ...
        iconColor = iconColor,
        imageProvider = ImageProvider(context.getDrawableIdByName("rounded_skip_previous_filled_24")),
...
fun NextButton(
    ...
    WidgetIconButton(
        ...
        backgroundColor = backgroundColor,
        iconColor = iconColor,
        imageProvider = ImageProvider(context.getDrawableIdByName("rounded_skip_next_filled_24")),
...
fun PlayPauseButton(
    ...
    WidgetIconButton(
        ...
        iconColor = iconColor,
        imageProvider = ImageProvider(
            if (isPlaying) context.getDrawableIdByName("rounded_pause_filled_24")
            else context.getDrawableIdByName("rounded_play_arrow_filled_24")
        ),
        contentDescription = context.getStringByName(
            if (isPlaying) "common_pause" else "common_play"
        ),
        iconSize = iconSize,
        cornerRadius = cornerRadius
    )
...
fun ShuffleButton(
    ...
    WidgetIconButton(
        ...
        backgroundColor = backgroundColor,
        iconColor = iconColor,
        imageProvider = ImageProvider(context.getDrawableIdByName("rounded_shuffle_24")),
        contentDescription = context.getStringByName("common_shuffle"),
        cornerRadius = cornerRadius
    )
}
...
fun RepeatButton(
    ...
    WidgetIconButton(
        ...
        contentDescription = context.getStringByName("common_repeat"),
        cornerRadius = cornerRadius
    )
}
