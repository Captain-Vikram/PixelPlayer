...
import com.theveloper.pixelplay.feature.ktorserver.R
...
class MediaFileHttpServerService : Service() {
    ...
    private val musicRepository: SharedMusicDataSource?
        get() = HttpServerRegistry.dataSource
    ...
    companion object {
        ...
        fun configureCastSessionAccess(
